...
<span className="text-fiesta-pink">import</span> <span className="text-white">{'{'} React {'}'}</span> <span className="text-fiesta-pink">from</span> <span className="text-fiesta-orange">'jimu-core'</span>
<span className="text-fiesta-pink">import</span> <span className="text-white">{'{'} JimuMapView {'}'}</span> <span className="text-fiesta-pink">from</span> <span className="text-fiesta-orange">'jimu-arcgis'</span>

<span className="text-fiesta-pink">const</span> <span className="text-fiesta-turquoise">Widget</span> = <span className="text-white">(props)</span> <span className="text-fiesta-pink">=></span> {'{'}
  <span className="text-fiesta-pink">const</span> <span className="text-white">handleClick</span> = <span className="text-fiesta-pink">async</span> (view) <span className="text-fiesta-pink">=></span> {'{'}
    <span className="text-gray-500">// AI-generated logic</span>
    <span className="text-fiesta-pink">const</span> hit = <span className="text-fiesta-pink">await</span> view.<span className="text-fiesta-turquoise">hitTest</span>(event)
    <span className="text-white">showInfo</span>(hit.results[<span className="text-fiesta-orange">0</span>])
  {'}'}

  <span className="text-fiesta-pink">return</span> (
    {'<'}<span className="text-fiesta-turquoise">JimuMapView</span> <span className="text-white">onClick</span>={'{'}handleClick{'}'}{'>'}
